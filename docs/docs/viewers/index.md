...
| [Web viewer](./webrtc.md) | Implemented | Quick testing, demos, and browser capture workflows | No extension install; requires manual tab/window capture; Chrome and Firefox need different capture choices. |
